...
* [Analysis_of_HeadHunter_info(part 1).ipynb](./Analysis_of_HeadHunter_info(part 1).ipynb) [Analysis_of_HeadHunter_info(part 2).ipynb](./Analysis_of_HeadHunter_info(part 2).ipynb) - jupyter-ноутбук, содержащий основной код проекта, в котором демонстрируются методы и подходы решения задач очистки данных. Из-за ограничений на размер файлов загружаемых на/с GitHub файл разделен на две части.
...
Из-за ограничений на размер файлов загружаемых на/с GitHub файл разделен на две части.
